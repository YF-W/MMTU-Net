"""
新baseline，将transformer的结果直接传入bottleneck
"""
import torch
...
class Baseline(nn.Module):
    def __init__(self,in_channel,out_channel,features=[64, 128, 256, 512]):
        ...
        for feature in reversed(features):
            self.ups.append(
                nn.ConvTranspose2d(
                    feature * 2 + feature, feature * 2, kernel_size=3, stride=1,padding=1
                )
            )
