"""
transformer只放在最后一层，双卷积也是全用普通3*3的卷积，transformer的输入是q,k,v是原图、第一层和第二层传入transformer，第三层传入aspp
"""
#!/usr/bin/env python
#coding=utf-8
import torch
...
class vit_transformer(nn.Module):
    def __init__(self, *, in_channel,out_channel,image_size, patch_size, dim, heads, mlp_dim, pool='cls', channels=3,
        ...
        self.vitLayer_UpConv = nn.ConvTranspose2d(51, 51, kernel_size=2, stride=2)
